...
func (m *Model) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case walBlockDetailLoadedMsg:
		return m, m.onWALBlockDetailLoaded(msg)
	...
	case statementLogSampleLoadedMsg:
		return m, m.onStatementLogSampleLoaded(msg)
	...
	case pgbProbedMsg:
		return m, m.onPgbProbed(msg)
	case pgbOverviewLoadedMsg:
		return m, m.onPgbOverviewLoaded(msg)
	case pgbShowLoadedMsg:
		return m, m.onPgbShowLoaded(msg)
	case pgbTickMsg:
		return m, m.onPgbTick()
