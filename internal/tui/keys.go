...
func defaultKeys() keyMap {
	return keyMap{
		...
		SortHitRatio: key.NewBinding(key.WithKeys("c"), key.WithHelp("c", "sort: hit ratio")),
...
func (k keyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		...
		{k.Enter, k.Back},
		{k.SortSize, k.SortName, k.SortHitRatio},
		{k.Refresh, k.ToggleBloat},
		{k.Help, k.Quit},
	}
}
